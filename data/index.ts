export const ServiceData = [
  {
    ...
    points: ["Oil & Filter Change", "Brake Service", "Cooling System Flush", "Check Fluid Levels", "Tire Rotation", "Air Filter", "Transmission Fluid Service", "Shock & Struts", "Serpentine Belt"],
    description:
  ...
  {
    title: "performance",
    points: ["Cooling", "Engine Internals", "Exhuast", "Forced Induction", "Intake", "Tuning Services", "Seats & Safety", "Aerodynamics", "Fuel"],
    description:
  ...
  {
    title: "suspension",
    points: ["Springs", "Coilover Springs", "Air Suspension (Cup Kits / Full Air)", "Lift Kits", "Shocks", "Suspension Controllers", "Linkage / Geometry", "Accesories"],
    description:
  ...
  },
  {
    ...
    points: ["Vinyl Wrap", "3M", "Avery", "Inozetek", "Tint", "Ceramic", "Carbon Ceramic", "Hybrid", "Dyed"],
    description:
  ...
  {
    title: "audio",
    points: ["Speakers", "Sub-woofers", "Sub Enclosures", "Amplifiers", "Single / Double Din Radios"],
    description:
  ...
  {
    title: "wheels & tires",
    points: ["Advan", "BBS", "Rays", "Forgiatos", "HRE", "Falken", "Toyo Tires", "Yokohama-Advan", "Michelin Tires"],
    description:
